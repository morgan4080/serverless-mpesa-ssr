...
module.exports.register = data => {
    return createTable.createCollection(dbconfig.businessCollection)
        .then((result) => console.log('business table creation results', result))
...
function registerC2B(genData, data) {
    return new Promise((resolve, reject) => {
...
function registerBusiness(c2bData, data) {
    return new Promise((resolve, reject) => {
        if(!c2bData) {
            reject ({
                c2bData: c2bData,
